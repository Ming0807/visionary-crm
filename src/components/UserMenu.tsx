...
import { LogOut, ChevronDown, User, Package, Settings, UserPlus, LogIn } from "lucide-react";
...
export default function UserMenu() {
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-56">
                        ...
                        <DropdownMenuItem onClick={login} className="cursor-pointer">
                            <svg 
                                viewBox="0 0 24 24" 
                                className="h-4 w-4 mr-2 fill-[#00B900]"
                                aria-hidden="true"
                            >
    ...
    // Get display info - from customer or LINE profile
    const displayName = customer?.name || profile?.displayName || "User";
    const profileImage = customer?.profileImageUrl || profile?.pictureUrl;
